...
private:
    bool is(const nmea0183_connector::NmeaSentence& sentence, const char* id) const { return nmea0183_connector::sentence_is(sentence, id); }
    ...
    void mark_changed_from_sentence(const nmea0183_connector::NmeaSentence& sentence, SourceId source_id, uint64_t now_us) {
        ...
        if (is(sentence, "RMC") || is(sentence, "VTG")) { mark(ModelField::GnssSpeedKn, source_id, now_us); mark(ModelField::GnssTrackDeg, source_id, now_us); }
        ...
        if (is(sentence, "MWD")) { mark(ModelField::WindTrueDirectionDeg, source_id, now_us); mark(ModelField::WindTrueSpeedKn, source_id, now_us); }
        if (is(sentence, "VWR")) { mark(ModelField::WindApparentDirectionDeg, source_id, now_us); mark(ModelField::WindApparentSpeedKn, source_id, now_us); }
        if (is(sentence, "VWT")) { mark(ModelField::WindTrueDirectionDeg, source_id, now_us); mark(ModelField::WindTrueSpeedKn, source_id, now_us); }
        if (is(sentence, "MDA")) {
            mark(ModelField::EnvBarometricPressureInHg, source_id, now_us); mark(ModelField::EnvBarometricPressureBar, source_id, now_us); mark(ModelField::EnvAirTemperatureC, source_id, now_us); mark(ModelField::SeaTemperatureC, source_id, now_us); mark(ModelField::EnvRelativeHumidityPercent, source_id, now_us); mark(ModelField::EnvAbsoluteHumidityPercent, source_id, now_us); mark(ModelField::EnvDewPointC, source_id, now_us); mark(ModelField::WindSurfaceDirectionDeg, source_id, now_us); mark(ModelField::WindTrueDirectionDeg, source_id, now_us); mark(ModelField::WindSurfaceDirectionMagneticDeg, source_id, now_us); mark(ModelField::WindSurfaceSpeedKn, source_id, now_us); mark(ModelField::WindTrueSpeedKn, source_id, now_us); mark(ModelField::WindSurfaceSpeedMs, source_id, now_us); mark(ModelField::WindTrueSpeedMs, source_id, now_us);
        }
        ...
        if (is(sentence, "RPM")) { mark(ModelField::PropulsionRevolutionsNumber, source_id, now_us); mark(ModelField::PropulsionRevolutionsSpeedRpm, source_id, now_us); mark(ModelField::PropulsionRevolutionsPitchPercent, source_id, now_us); }
        if (is(sentence, "RSA")) mark(ModelField::SteeringRudderAngleDeg, source_id, now_us);
        if (is(sentence, "VLW")) { mark(ModelField::RouteLogTotalDistanceNmi, source_id, now_us); mark(ModelField::RouteLogTripDistanceNmi, source_id, now_us); }
        ...
        if (is(sentence, "RMB")) { mark_rmb(source_id, now_us); mark(ModelField::RouteApbXteNmi, source_id, now_us); mark(ModelField::RouteApbOriginToDestinationBearingDeg, source_id, now_us); }
        if (is(sentence, "BOD") || is(sentence, "BWW")) { mark(ModelField::RouteWaypointBearingTrueDeg, source_id, now_us); mark(ModelField::RouteWaypointBearingMagneticDeg, source_id, now_us); mark(ModelField::RouteWaypointToId, source_id, now_us); mark(ModelField::RouteWaypointFromId, source_id, now_us); }
        if (is(sentence, "BEC") || is(sentence, "BWC") || is(sentence, "BWR")) mark_waypoint(source_id, now_us);
        if (is(sentence, "WPL")) { mark(ModelField::RouteWaypointLatDeg, source_id, now_us); mark(ModelField::RouteWaypointLonDeg, source_id, now_us); mark(ModelField::RouteWaypointToId, source_id, now_us); }
        if (is(sentence, "WCV")) { mark(ModelField::RouteRmbClosingVelocityKn, source_id, now_us); mark(ModelField::RouteRmbDestinationId, source_id, now_us); mark(ModelField::RouteWaypointToId, source_id, now_us); }
        if (is(sentence, "WDC") || is(sentence, "WDR") || is(sentence, "WNC")) { mark(ModelField::RouteWaypointDistanceNmi, source_id, now_us); mark(ModelField::RouteWaypointToId, source_id, now_us); mark(ModelField::RouteWaypointFromId, source_id, now_us); }
        if (is(sentence, "XTE") || is(sentence, "XTR")) { mark(ModelField::RouteApbXteNmi, source_id, now_us); mark(ModelField::RouteRmbXteNmi, source_id, now_us); }
        if (is(sentence, "R00") || is(sentence, "RTE")) mark(ModelField::RouteActiveWaypointCount, source_id, now_us);
        if (is(sentence, "HSC")) { mark(ModelField::RouteHeadingSteeringCommandTrueDeg, source_id, now_us); mark(ModelField::RouteHeadingSteeringCommandMagneticDeg, source_id, now_us); mark(ModelField::RouteApbHeadingToSteerDeg, source_id, now_us); }
        if (is(sentence, "ZDL")) { mark(ModelField::RouteWaypointDestinationTimeRemainingS, source_id, now_us); mark(ModelField::RouteWaypointDistanceNmi, source_id, now_us); mark(ModelField::RouteWaypointToId, source_id, now_us); }
        if (is(sentence, "ZFO")) { mark(ModelField::RouteWaypointOriginUtcTimeS, source_id, now_us); mark(ModelField::RouteWaypointOriginElapsedTimeS, source_id, now_us); mark(ModelField::RouteWaypointFromId, source_id, now_us); }
        if (is(sentence, "ZTG")) { mark(ModelField::RouteWaypointDestinationUtcTimeS, source_id, now_us); mark(ModelField::RouteWaypointDestinationTimeRemainingS, source_id, now_us); mark(ModelField::RouteWaypointToId, source_id, now_us); }
        if (is(sentence, "HFB") || is(sentence, "TDS") || is(sentence, "TPC") || is(sentence, "TPR") || is(sentence, "TPT")) mark_trawl(source_id, now_us);
        if (is(sentence, "VDM") || is(sentence, "VDO")) { mark(ModelField::AisTargetsObject, source_id, now_us); mark(ModelField::AisOwnVesselObject, source_id, now_us); mark(ModelField::AisSafetyObject, source_id, now_us); }
        ...
        if (is(sentence, "SM1") || is(sentence, "SM2") || is(sentence, "SM3") || is(sentence, "SM4") || is(sentence, "SMB") || is(sentence, "CAN") || is(sentence, "CRQ") || is(sentence, "DSM") || is(sentence, "TMD")) mark(ModelField::InmarsatSafetyNetStructuredNotification, source_id, now_us);
        if (is(sentence, "ACK") || is(sentence, "AKD") || is(sentence, "ALA") || is(sentence, "ALC") || is(sentence, "ALF") || is(sentence, "ALR") || is(sentence, "ARC") || is(sentence, "HBT") || is(sentence, "FIR")) mark(ModelField::AlertStructuredNotification, source_id, now_us);
        if (is(sentence, "MOB") || is(sentence, "SMV")) mark(ModelField::MobStructuredNotification, source_id, now_us);
        if (is(sentence, "FSI") || is(sentence, "MSK") || is(sentence, "MSS") || is(sentence, "RLM") || is(sentence, "CEK") || is(sentence, "COP") || is(sentence, "DCR") || is(sentence, "DDC") || is(sentence, "DOR")) mark(ModelField::LegacyCommObject, source_id, now_us);
        if (is(sentence, "TXT") || is(sentence, "ALR") || is(sentence, "ACK") || is(sentence, "HBT") || is(sentence, "FIR") || is(sentence, "NRX") || is(sentence, "NRM") || is(sentence, "SM1") || is(sentence, "SM2") || is(sentence, "SM3") || is(sentence, "SM4") || is(sentence, "SMB") || is(sentence, "MOB")) { mark(ModelField::NotificationText, source_id, now_us); mark(ModelField::NotificationEvent, source_id, now_us); }
