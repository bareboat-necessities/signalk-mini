...
public:
    bool map_change(const ship_data_model::DataModel<Real>& model, const ModelChange& change, SignalKMappedValue<Real>& out) const {
        switch (change.field) {
        case ModelField::GnssFixLatDeg: return map_number(model.gnss.fix.fix_lat_deg, signalk_path::NavigationPositionLatitude, out);
        ...
        case ModelField::ImuPitchDeg: return map_number(model.ins.imu.pitch_deg, signalk_path::NavigationAttitudePitch, out, UnitTransform::DegToRad);
        case ModelField::ImuRollDeg: return map_number(model.ins.imu.roll_deg, signalk_path::NavigationAttitudeRoll, out, UnitTransform::DegToRad);
        ...
        case ModelField::SeaCurrentSpeedKn: return map_number(model.sea.current_speed_kn, signalk_path::EnvironmentCurrentSpeed, out, UnitTransform::KnotsToMps);
        case ModelField::SeaCurrentDirectionDeg: return map_number(model.sea.current_direction_deg, signalk_path::EnvironmentCurrentDirectionTrue, out, UnitTransform::DegToRad);
        case ModelField::SeaCurrentDirectionMagneticDeg: return map_number(model.sea.current_direction_magnetic_deg, signalk_path::EnvironmentCurrentDirectionMagnetic, out, UnitTransform::DegToRad);
        ...
        case ModelField::SeaDepthOffsetM: return map_number(model.sea.depth_offset_m, signalk_path::EnvironmentDepthTransducerOffset, out);
        ...
        case ModelField::AutopilotMode: return map_text(signalk_autopilot_mode(model.autopilot.controller.mode.value), signalk_path::SteeringAutopilotMode, out);
        case ModelField::AutopilotEnabled: return map_bool(model.autopilot.controller.enabled.value, signalk_path::SteeringAutopilotEnabled, out);
        ...
        case ModelField::RouteApbArrivalCircleEntered: return map_bool(model.route.apb.arrival_circle_entered.value, signalk_path::NavigationCourseGreatCircleArrivalCircleEntered, out);
        case ModelField::RouteApbPerpendicularPassed: return map_bool(model.route.apb.perpendicular_passed.value, signalk_path::NavigationCourseGreatCirclePerpendicularPassed, out);
        ...
        case ModelField::RouteRmbArrived: return map_bool(model.route.rmb.arrived.value, signalk_path::NavigationCourseGreatCircleArrived, out);
        ...
        case ModelField::RouteWaypointArrivalCircleEntered: return map_bool(model.route.waypoint_arrival.arrival_circle_entered.value, signalk_path::NavigationCourseGreatCircleArrivalCircleEntered, out);
        case ModelField::RouteWaypointPerpendicularPassed: return map_bool(model.route.waypoint_arrival.perpendicular_passed.value, signalk_path::NavigationCourseGreatCirclePerpendicularPassed, out);
        ...
        case ModelField::AisTargetsObject: return map_object(signalk_path::NavigationAisTargets, SignalKObjectKind::AisTargets, out);
        case ModelField::AisOwnVesselObject: return map_object(signalk_path::NavigationAisOwnVessel, SignalKObjectKind::AisOwnVessel, out);
