...
public:
    bool map_change(const ship_data_model::DataModel<Real>& model, const ModelChange& change, SignalKMappedValue<Real>& out) const {
        ...
        case ModelField::TrawlHeadropeToFootropeM: return map_number(model.fishing.trawl.headrope_to_footrope_m, "fishing.trawl.headropeToFootrope", out);
        case ModelField::TrawlHeadropeToBottomM: return map_number(model.fishing.trawl.headrope_to_bottom_m, "fishing.trawl.headropeToBottom", out);
        case ModelField::TrawlDoorCenterlineOffsetM: return map_number(model.fishing.trawl.door_centerline_offset_m, "fishing.trawl.door.centerlineOffset", out);
        case ModelField::TrawlDoorAlongCenterlineM: return map_number(model.fishing.trawl.door_along_centerline_m, "fishing.trawl.door.alongCenterline", out);
        case ModelField::TrawlCartesianCenterlineOffsetM: return map_number(model.fishing.trawl.cartesian_centerline_offset_m, "fishing.trawl.cartesian.centerlineOffset", out);
        case ModelField::TrawlCartesianAlongCenterlineM: return map_number(model.fishing.trawl.cartesian_along_centerline_m, "fishing.trawl.cartesian.alongCenterline", out);
        case ModelField::TrawlDepthBelowSurfaceM: return map_number(model.fishing.trawl.depth_below_surface_m, "fishing.trawl.depthBelowSurface", out);
        case ModelField::TrawlRelativeRangeM: return map_number(model.fishing.trawl.relative_range_m, "fishing.trawl.relative.range", out);
        case ModelField::TrawlRelativeBearingDeg: return map_number(model.fishing.trawl.relative_bearing_deg, "fishing.trawl.relative.bearing", out, UnitTransform::DegToRad);
        case ModelField::TrawlTrueRangeM: return map_number(model.fishing.trawl.true_range_m, "fishing.trawl.true.range", out);
        case ModelField::TrawlTrueBearingDeg: return map_number(model.fishing.trawl.true_bearing_deg, "fishing.trawl.true.bearing", out, UnitTransform::DegToRad);
